...
type Config struct {
	...
	PortionContractDeployHeight uint64                            `yaml:"portionContractDeployHeight"`
...
func (idx *Indexer) Start(ctx context.Context) error {
	...
	idx.lastHeight = uint64(3638925 - 360)
...
func (idx *Indexer) RegisterDefaultProtocols() error {
	...
	votingsProtocol, err := votings.NewProtocol(idx.Store, idx.epochCtx, idx.Config.GravityChain, idx.Config.Poll, idx.Config.VoteWeightCalConsts, idx.Config.RewardPortionContract, idx.Config.PortionContractDeployHeight)
	if err != nil {
