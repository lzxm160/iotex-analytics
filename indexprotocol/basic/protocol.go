...
const (
	...
	// ActionHistoryName is the table name of action history
	ActionHistoryName = "action_history"

	// BlockFooterHistoryName is the table name of block footer history
	BlockFooterHistoryName = "block_footer_history"

	// BlockHeaderHistoryName is the table name of block header history
	BlockHeaderHistoryName = "block_header_history"
	// ReceiptHistoryName is the table name of receipt history
	ReceiptHistoryName = "receipt_history"
)
