...
func (p *Protocol) getKickoutCount(db *sql.DB, startEpoch int, epochCount int, delegateName string) (count uint64, err error) {
	getQuery := fmt.Sprintf(selectKickoutCount,
